...
import type { CourseDTO, SelfPacedVideoDTO } from '../../models/dashboard/dashboard';
...
export default function QnA() {
    ...
    return (<div className="mt-4">
        <div className="tab-pane fade show active mt-4 pb-5" id="home" role="tabpanel" aria-labelledby="home-tab">
            {videoData &&
                videoData.CourseWisePerformance != null && videoData.CourseWisePerformance != undefined &&
                <div className='row'>
            ...
            <div className="row pt-3">
                {
                    (videoData != null && videoData.courseContentList != null && videoData.courseContentList.length > 0) ?
                        <div>
                            {
                                (videoData.IsQnASubscribed == false || videoData.IsTrialSubscribed == true || videoData.IsMembershipQnASubscribed == false)  && <div className="box-shadow">
                                    <div className="p-2">
                                        <span className="float-start mt-2 ms-2 mb-3"><strong>Subscribe QnA</strong> - Subscribe and get access to all Interview Q&A.</span>
                                                                            ...
                                                                            return <div style={{ padding: '8px', borderBottom: '1px solid #e4ecf2'}} key={stIndex}>
                                                                                <div className='row'>
                                                                                    ...
                                                                                    <i style={styleBookMarked} className={subTopic.IsBookmarked?'fas fa-bookmark':'far fa-bookmark'} onClick={() => bookMarkClick(subTopic.SubTopicId, course.CourseId)} title="Create Bookmark"></i>&nbsp;&nbsp;
                                                                                         ...
                                                                                         <VideoActions subTopic={subTopic} IsSubscribed={videoData.IsQnASubscribed} cloudCodePath={cloudCodePath} cloudPdfPath={cloudPdfPath} course={course} courseid={courseid} batchid={batchid} subscriptionid={subscriptionid} topic={topic} isFreeTrial={videoData.IsTrialSubscribed} selfplaced="qna" membership={videoData.IsMembershipQnASubscribed}></VideoActions>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        })
