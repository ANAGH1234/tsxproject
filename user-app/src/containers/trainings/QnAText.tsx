...
import QnATextAction from '../Action/QnATextAction';

const zeroPad = (num: any, places = 2) => String(num).padStart(places, '0')

export default function QnAText() {
            ...
            <div className="tab-pane fade show active mt-4 pb-5" id="home" role="tabpanel" aria-labelledby="home-tab">
                {
                    (qnATextData != null && qnATextData.CourseQuickNote != null && qnATextData.CourseQuickNote.length > 0) ?
                        <div className="pt-3">
                            {
                                (qnATextData.IsQnASubscribed == false || qnATextData.IsTrialSubscribed == true || qnATextData.IsMembershipQuickNoteSubscribed == false) && <div className="box-shadow">
                                    <div className="p-2">
                                                    ...
                                                    content.InterviewQuestionList.map((item: any, index: number) => {
                                                        ...
                                                        return <div className='row' style={{ padding: '10px', margin: '0', borderBottom: '1px solid #e4ecf2', lineHeight: '28px' }} key={index}>
                                                            ...
                                                            <span className='col-sm-5 col-xs-12' style={{ fontSize: '14px', textAlign: 'right' }}>
                                                                ...
                                                                <QnATextAction content={content} item={item} isQnATextStarted={isQnATextStarted} qnATextData={qnATextData} courseid={courseid} subscriptionid={subscriptionid} membership={qnATextData.IsMembershipQuickNoteSubscribed} access={true}></QnATextAction>
                                                            </span>
                                                        </div>
                                                    })
                                                }
