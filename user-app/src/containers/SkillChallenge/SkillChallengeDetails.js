            ...
            <div>
                <div className='catinfo'>
                    <div className='row' style={{ height: '50px' }}>
                        ...
                        <div className='col-md-3 d-flex align-items-center'><i style={{ fontSize: '24px' }} className="far fa-clock"></i>&nbsp;&nbsp;<strong>{timer}</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a className='btn btn-warning' style={{ fontSize: '14px', color: '#ff615e', background: 'rgba(255,97,94,.2)' }} onClick={() => exitTest()}>Exit Test</a></div>
                    </div>
                </div>
