...
const Schedules: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      TrainingService.getCourseList().then((res) => setCourseData(res)),
  ...
  useEffect(() => {
    setIsLoading(true);
    TrainingService.getSchedules(user.userId, selectedCourseId, selectedZone, isMore)
      .then((res) => {
      ...
      .finally(() => setIsLoading(false));
  }, [selectedCourseId, selectedZone, user.userId]);
                          ...
                          return (
                            <div className="row schedule-row" key={bindex}>
                              <div className="col-sm-1 col-3">
                                <img
                                  src={batch.MobileBanner ?? "/path/to/default-image.png"}
                                  alt={batch.CourseName ?? "Course"}
                                  className="img-fluid"
